...
Utilizados para criar a atmosfera visual do Cerrado Brasileiro com fauna local:
- **Lobo Guará & Araras (Original):**
...
- **Extrator de Documentos com Fusão Frente/Verso:** Sistema inteligente que permite carregar a imagem da Frente e, posteriormente, a do Verso do documento de identificação (RG/CNH), mesclando os dados cadastrais (CPF, Nome, Paternidade/Maternidade, Nascimento, Data de Emissão) de forma cumulativa sem apagar as leituras anteriores.
